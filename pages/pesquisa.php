...
$resultados = array_filter($prestadores, function ($p) use ($busca) {
...
<head>
  ...
  <title>Pesquisa - SkillMatch</title>
...
<body>
  ...
  <div class="container my-5 pt-5">
    <h2 class="mb-4 text-center">Resultados da busca: <em><?= htmlspecialchars($busca) ?></em></h2>
      ...
      <?php else: ?>
        <div class="col-12">
          <div class="alert alert-warning text-center">
            Nenhum resultado encontrado para "<strong><?= htmlspecialchars($busca) ?></strong>".
          </div>
        </div>
      <?php endif; ?>
    </div>
